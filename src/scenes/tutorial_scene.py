...
TUTORIAL_TEXT = "Le but de ce jeu est d'illustrer un problème d'ordonnancement : le flow-shop à deux machines. Concrètement, vous allez devoir aider des personnages à traverser des ponts le plus rapidement possible, en les triant dans l'ordre de votre choix. Vos personnages affronterons d'autres personnages triées par une IA très perfectionnée. Mais attention ! les ponts sont fragiles, et seulement un seul personnage peut monter sur un pont à la fois. De plus, chaque personnage met un temps différent à traverser chaque pont ! Il vous faudra donc trier les personnes afin d'optimiser le temps de passage de chaque personnage, et ainsi, battre le tri de l'IA."
